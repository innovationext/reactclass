...
class Contact extends Component {
    ...
    constructor(props) {
        ...
        // REMOVED DURING EXERCISE: REACT REDUX FORM
    ...
    //     //initial error values is empty string
    //     const errors = {
    //         firstName: '',
    //         lastName: '',
    //         phoneNum: '',
    ...
    render() {
        ...
        //const errors = this.validate(this.state.firstName, this.state.lastName, this.phoneNum, this.state.email);
